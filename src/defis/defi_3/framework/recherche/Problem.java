package defis.defi_3.framework.recherche;
...
import defis.defi_3.framework.common.StateActionPair;
...
*
*
* <p>Cette classe ajoute un ensemble détat et de transition à {@link SearchProblem}. Pour un exemple, voir la classe {@link defis.defi_3.problemes.Vacuum})</p>
*
*/
...
public abstract class Problem extends SearchProblem {
    ...
    /**
     * La liste des états a remplir (voir {@link defis.defi_3.problemes.Vacuum})
     */
    
    protected static State[] STATES = null ;

    /**
     * La liste des transition a remplir (voir {@link defis.defi_3.problemes.Vacuum})
     */
